...
st.set_page_config(
    page_title="Product Line Profitability & Margin Performance Analysis for Nassau Candy Distributor",
    layout="wide"
)
# -------------------------------------------------
# Custom Styling
...
/* Remove tick lines (extra small lines) */
...
/* Slider min/max labels (0 and 100) */
...
/* Slider value (center number like 61) */
div[data-baseweb="slider"] span {
    color: #ffffff !important;
    font-weight: 600 !important;
}

/* Remove unwanted inline red color */
div[data-baseweb="slider"] span[style*="color"] {
    color: #ffffff !important;
}
/* ----------- Buttons ----------- */
